...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("인자로 전달한느 값 : " + iarr);
...
//        pt.testVariableLengthArrayParameter();    // 인자가 아무것도 없는 경우 에러 발생
        pt.testVariableLengthArrayParameter("홍길동");   // 가변인자는 전달하지 않아도 된다.(0개 일수도 있기 때문에)
        pt.testVariableLengthArrayParameter("이순신","볼링");  //1개도 가능
        pt.testVariableLengthArrayParameter("신사임당","볼링","축구","배드민턴");  //여러개도 가능
