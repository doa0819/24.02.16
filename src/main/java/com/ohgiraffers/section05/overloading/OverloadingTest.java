...
public class OverloadingTest {
    ...
    /* 필기.
    *   오버로딩의 사용 이유
    *   매개변수의 종료별로 메소드 내용울 다르게 작성해야 하는 경우들이 종종 있다.
    ...
    *   다르게 작성하여 한 클래스 내에 동일한 이름의메소드를 여러 개 작성할 수 있다.
...
//        public void test() {}     //test() -> 메소드 시그니쳐
...
//    public int test(){return 0;}
    ...
    // 매개변수 유무에 따른 오버로딩 성립 확인
     public void test(int num){}     // 매개변수[() 안에 있는거] 도 메소드시그니처에 포함이기 때문에 다르면 다르게 인신
