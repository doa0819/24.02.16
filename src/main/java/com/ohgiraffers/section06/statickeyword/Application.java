...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 필기.
        *   static
        *   : 정적 메모리 영역에 프로그램이 start 될 때 할당을 하는 키워드 이다.
        *   인스턴스를 생성하지 않고도 사용할 클래스의 맴버(필드, 메소드)에 지정할 수 있다.
        *   여러 인스턴스가 공유해서 사욯할 목적의 공간이다.
       ...
       /* 현재 두 필드가 가지고 있는 값 확인 */
        ...
        // static field 는 값을 공유하기 때문에 한번 증가가 되면 증가한 값을 가지고 있다(새로운 매개변수를 만들어도 값은 그대로 가지고 있다.)

        /*필기.
        *  인스턴스 변수의 경우 sft1 과 sft2 두개의 인스턴스가 서로 값을 공유 하지 못하고
