...
public class Appliction01 {
    ...
    public static void main(String[] args) {
        ...
        *   아이디, 비밀번호, 이름, 나이, 성별, 취미 를 연속된 메모리 공간(주소) 에서 사용하도록 공간을 만들었다.
        *   클래스에 작성한 내용대로 사용할 수 있다.
        * */

        Member member = new Member();    //class 자체가 자료형 이다!!!!!!!!!
        ...
        * */
        ...
        /* 필기.
        *   필드에 접근하기 위해서는 래퍼런스변수명.(member 주소값 가지고 있는 변수)필드명  <- 이렇게 접근한다.
        *   '.' 참조연산자 : 래퍼런스 변수가 참조하고 있는 주소로 접근한다 라는 의미
        *   각 공간은 필드명으로 접근한다. */
        ...
        System.out.println("변경 후 member. neme : " + member.name);
