...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업목표. 객체지향 프로그래밍에 대해 이해하과 객체와 클래스를 설계하여 프로그래밍 할 수 있다. */
        /* 필기.
        *   객체 지향 프로그래밍이란?
        *   현실세계의 모든 사건(event)는 객체와 객체의 상호작용에 의해 일어난다는 세계관을
        *   프로그램을 만들 때 이용하여 새로운 새계를 창조하는 방법론이다.
        *   현실 세계와 닮아있지만, 다른점은
        ...
        *   현실 세계를 프로그램의 목적에 맞게 단순화하는 '추상화' 하는 기법을 적용하게 된다.*/

        /* 필기.
        *   추상화란>
        *   공통괸 부분을 추출하고 공통되지 않은 부분을 제거한다는 의미를 가지며, 추상화의 목적은
        *   유연성을 확보하기 위함이다.
        *   유연성 확보는 여러 곳에 적용될 수 있는 유연한 객체를 의미하며, 즉 재사용성이 높아질 수
        *   있게 한다는 의미이다.
        *   객체의 재사용성이 증가하면 증복 작성되는 코드를 줄일 수 있으며, 오류 발생 가능성을
        *   감소 시키고 유지보수성을 증가시킨다.
        * */
        ...
        *   즉, 필드 보다는 메소드를 중접으로 추상화 기법을 적용하여 객체를 설계하고,
        ...
        *  */
        ...
        while (true){
            ...
            switch (no){
                ...
                default:
                    System.out.println("잘못된 번호를 입력했습니다.");break;   //default else 같은 느낌
            }
